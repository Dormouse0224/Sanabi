...
enum ImGuiTooltipFlags_
{
    ...
    ImGuiTooltipFlags_OverridePrevious          = 1 << 1,   // Unbind/ignore previously submitted tooltip (defaults to append)
};
...
struct ImGuiSettingsHandler
{
    ...
    void        (*ClearAllFn)(ImGuiContext* ctx, ImGuiSettingsHandler* handler);                                // Unbind all settings data
...
//#endif
    ...
    IMGUI_API ImGuiID       DockBuilderSplitNode(ImGuiID node_id, ImGuiDir split_dir, float size_ratio_for_node_at_dir, ImGuiID* out_id_at_dir, ImGuiID* out_id_at_opposite_dir); // CreateScript 2 child nodes in this parent node.
